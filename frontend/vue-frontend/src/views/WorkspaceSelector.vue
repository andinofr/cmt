        ...
        >
          <div class="p-8">
            ...
            <div class="mb-6 flex justify-center">
              <div :class="`w-24 h-24 rounded-2xl bg-gradient-to-br ${workspace.color} flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 shadow-lg`">
          ...
          <!-- Hover Effect -->
          <div class="absolute inset-0 bg-gradient-to-br from-[#007d79]/0 to-[#007d79]/0 group-hover:from-[#007d79]/5 group-hover:to-[#007d79]/10 transition-all duration-300 pointer-events-none"></div>
        </button>
      </div>
    </div>
  </div>

    ...
    <div class="max-w-7xl mx-auto px-8 py-8">
      ...
      <Tabs v-model="activeTab" class="space-y-6">
        <TabsList class="bg-white p-1 shadow-sm border border-slate-200">
          <TabsTrigger value="lifecycle" class="data-[state=active]:bg-[#007d79] data-[state=active]:text-white px-8 py-2.5">
            Contract Lifecycle
          </TabsTrigger>
          <TabsTrigger value="reminders" class="data-[state=active]:bg-[#007d79] data-[state=active]:text-white px-8 py-2.5">
            Expiry Reminders
          </TabsTrigger>
        </TabsList>
                      ...
                      <div class="flex items-center gap-3 mb-2">
                        ...
                        <span
                          ...
                          :class="`text-xs px-2 py-1 rounded flex items-center gap-1 ${
                            getContractExpiryStatus(contract.endDate) === 'critical' ? 'bg-red-100 text-red-700' : 'bg-yellow-100 text-yellow-700'
                          }`"
                        >
                          <AlertCircle v-if="getContractExpiryStatus(contract.endDate) === 'critical'" class="w-3 h-3" />
                    ...
                    >
                      <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                          ...
                          <p v-if="doc.contractId" class="text-xs text-slate-500 mb-2">
                    ...
                    >
                      ...
                      <td class="py-3 px-4">
                        <span :class="`flex items-center gap-1 text-sm font-medium ${
                          getContractExpiryStatus(contract.endDate) === 'critical' ? 'text-red-700' : 'text-yellow-700'
                        }`">
                          <AlertCircle v-if="getContractExpiryStatus(contract.endDate) === 'critical'" class="w-4 h-4" />
                          <AlertTriangle v-else class="w-4 h-4" />
                          {{ getContractExpiryStatus(contract.endDate) === 'critical' ? 'Critical (<3 months)' : 'Warning (<6 months)' }}
                        </span>
                      </td>
                    </tr>
                  </tbody>
